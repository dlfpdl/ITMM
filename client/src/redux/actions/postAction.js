...
export const updatePost = ({
  ...
  if (
    ...
    status.titlea === titlea &&
    status.titleb === titleb &&
    status.titlec === titlec &&
    status.titled === titled &&
    status.titlee === titlee &&
    status.titlef === titlef &&
    status.titleg === titleg &&
    status.titleh === titleh &&
    status.titlei === titlei &&
    status.titlej === titlej &&
    status.titlek === titlek &&
    status.titlel === titlel &&
    status.titlem === titlem &&
    imgNewUrl.length === 0 &&
